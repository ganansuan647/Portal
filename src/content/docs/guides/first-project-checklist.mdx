...
<CardGrid>
  ...
  <Card title="Arranging interests">
    - If additional expertise or manpower is needed, arrange for ScrewFast construction interests in advance
...
<LinkCard
  ...
  description="Access in-depth documentation and user manuals for ScrewFast tools and interests."
